...
export const componentRegistry: CaseStudy = {
  ...
  heroMedia: {
    src: "/work/component-registry/contract-ui.png",
    alt: "Component registry contract — whenToUse, props, accessibility, and Figma mapping in structured JSON",
    fit: "cover",
  },
  metrics: [
  ...
  artifacts: [
    ...
    },
    {
      ...
      blurb: "Product domains: glossary, business rules, UI composition for complex flows.",
      isPrivate: true,
    },
    {
      id: "code",
  ...
  sections: [
    {
      ...
      images: [
        {
          label: "Registry contract JSON — whenToUse, props, accessibility, Figma keys",
          aspect: "wide",
          src: "/work/component-registry/contract-ui.png",
          alt: "Component registry contract — whenToUse, props, accessibility, and Figma mapping in structured JSON",
          fit: "contain",
        ...
        {
          label: "Figma frame vs registry contract for the same Button variant",
          aspect: "pair",
          src: "/work/graphics/component-registry/contract-vs-frame.svg",
          alt: "Comparison of a static Figma screenshot versus structured JSON component contract",
          fit: "contain",
        },
      ],
    },
    {
      ...
      body: "Aurora ships thirty-six documented components across customer-facing product stacks. Luminis ships fifty-four components and forty composition patterns for internal admin apps. The registries mirror those boundaries so consumers query the right catalog.\n\nSplitting catalogs prevented internal admin patterns from leaking into customer UI contracts and vice versa. Shared token inventory still spans both where semantic roles align.",
      images: [
        {
          label: "Registry folder structure: aurora/components, luminis/composition-patterns",
          aspect: "wide",
          src: "/work/graphics/component-registry/registry-tree.svg",
          alt: "Tree diagram of Aurora and Luminis registry folder structure",
          fit: "contain",
        },
      ],
    },
    {
      ...
      body: "Button was the case study that proved contracts beat screenshots. One primitive carried weeks of design and engineering iteration, hundreds of variants, and tens of thousands of Figma inserts per year at low detach rate. Without a whenToUse entry, every squad invented a slightly different loading state, icon alignment, or destructive pairing.\n\nThe registry documents variant matrix, prop names aligned to Figma dev mode, keyboard focus behavior, and when not to use a button versus a link. Reviewers cite slug JSON in PR comments. Agents fetch the same file via aurora_get_components. One source, three audiences.",
    },
    {
      ...
      images: [
        {
          ...
          alt: "Illustration of global rules with blocker and advisory severity levels",
          fit: "contain",
        },
      ],
    },
    ...
    },
    {
      ...
      body: "Beyond atoms, feature registries describe product domains — checkout, dashboard, data entry — with glossaries, business rules, user states, and recommended UI composition. Agents implementing a feature call aurora_get_feature before picking components. That reduces product logic errors, not just visual drift.\n\nFeature JSON connects to related component slugs so an implementation query returns both the feature contract and the Card, Badge, and Skeleton entries it depends on.",
    },
    {
      heading: "Maintenance and outcomes",
      body: "Registry files ship in the same PR train as component changes. Definition of done: code, Storybook or reference page, registry JSON update. Stale contracts are worse than none — they train agents to lie confidently.\n\nDirectional wins: PR comments linking to slugs; fewer bespoke tables and modals in review; MCP resolve_from_figma returning actionable story IDs instead of generic advice. Tradeoff: JSON authoring tax on every new variant. Win: review time shifted from is this the right component to is this the right pattern for the state. Next: automated diff when Figma component keys change, prompting registry updates before merge.",
    },
  ],
};
